  ...
  <section className="text-gray-600 body-font bg-bg_primary">
    <div className="container mx-auto flex md:flex-row flex-col items-center">
      <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
        <h1 className="title-font sm:text-4xl text-3xl m-5 font-normal text-txt_secondary txt_s_font">
        <span className="font-semibold text-txt_primary txt_p_font">Cómo lavar:</span>
        <br />
        Aquí están las instrucciones que debes seguir para formar parte de nuestro equipo.
        </h1>
        <p className="m-5 leading-relaxed text-txt_secondary txt_s_font opacity-70">
